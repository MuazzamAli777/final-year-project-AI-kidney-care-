            ...
            <section id="contact" class="py-20 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            <div class="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4">Contact Us</div>
                            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Get in Touch with Our <span class="text-blue-600">Support Team</span></h2>
                            <p class="text-gray-600 mb-8 leading-relaxed">Have questions about our AI-powered kidney disease detection system? Our expert team is here to help you get started and answer any questions you may have.</p>
                            <div class="space-y-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-gray-600">+92 342 0315743</div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-gray-600">support@kidneyai.com</div>
                                        <div class="text-sm text-gray-500">We'll respond within 24 hours</div>
                                    </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div><div class="font-semibold text-gray-900 mb-1">Address</div><div class="text-gray-600">Office No. 12, Main Circular Road
Near DHQ Hospital
